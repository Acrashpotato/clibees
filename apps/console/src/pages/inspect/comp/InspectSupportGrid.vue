...
function switchSupportTab(nextTab: InspectSupportTab): void {
  ...
  <section class="audit-grid audit-grid--support">
    <article class="panel-card audit-card">
      <div class="panel-card__header">
        ...
        <span class="panel-chip">{{ activeSupportCount }}</span>
      </div>

      <div class="audit-support-tabs">
        <button
          v-for="tab in supportTabs"
          :key="tab.id"
          class="ghost-button audit-support-tab"
          type="button"
          :data-active="activeSupportTab === tab.id"
          @click="switchSupportTab(tab.id)"
        >
          {{ tab.label }} | {{ tab.count }}
        </button>
      </div>

      <template v-if="activeSupportTab === 'approvals'">
        <div class="panel-card__header">
          <div>
      ...
      <template v-else-if="activeSupportTab === 'validations'">
        <div class="panel-card__header">
          <div>
      ...
      <template v-else-if="activeSupportTab === 'replans'">
        <div class="panel-card__header">
          <div>
